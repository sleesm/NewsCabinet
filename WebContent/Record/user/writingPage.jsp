...
<body>
	...
	<div style="width:500px; height:350px; border:1px solid red; margin-left:20px;">
     ...
     <form method="post" action="/NewsCabinet/UserRecord/restore">
			...
			<%=today%>
			<br />
			 공개 설정 : <input type="radio" name="recordPrivate"
				value="false" checked> 공개 <input type="radio"
				name="recordPrivate" value="true"> 비공개
				<br />
			...
			<br>
			<div class="selectdiv" style="clear:both">
				...
				<input type="button" value="스크랩한 뉴스 고르기"
					onclick="getUserChosenScap()">
			...
			<br>
			<div>
				<iframe id='selectedNewsFrame' name='selectedNewsFrame' width='60%'
					height='400' style="display: none"></iframe>
			</div>
			<br> <br>
